...
export default function About() {
  ...
  const typedTexts = useTypingEffect(paragraphs, 50, 1000);

  return (
    <main className="popping-circles min-h-screen flex flex-col items-center justify-center bg-gray-100 py-10">
